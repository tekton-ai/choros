...
export function buildDeveloperResourcesSection(): string[] {
	...
	return [
		...
		`- [CLI](${docsUrl}/cli/getting-started): \`brew install superset-sh/tap/choros\` (Homebrew tap: https://github.com/superset-sh/homebrew-tap) or \`curl -fsSL https://choros.sh/cli/install.sh | sh\`; reference at ${docsUrl}/cli/cli-reference`,
