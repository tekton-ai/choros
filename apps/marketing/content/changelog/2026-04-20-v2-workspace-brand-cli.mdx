...
- Terminal: fixed output garbling with a new session transport <PRBadge url="https://github.com/superset-sh/superset/pull/3252" />
...
- V2 file tree: no longer blocks on slow git status checks; file icons resolve on nested routes <PRBadge url="https://github.com/superset-sh/superset/pull/3400" /> <PRBadge url="https://github.com/superset-sh/superset/pull/3199" />
