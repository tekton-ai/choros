...
Teach any agent to drive Choros itself with the official [skills](https://github.com/superset-sh/skills), one for the `choros` CLI and one for the [MCP server](/mcp-server):
