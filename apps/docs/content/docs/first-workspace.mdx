...
```text
Set up this project for Choros. Read docs.choros.sh/setup-teardown-scripts
and docs.choros.sh/ports, then author a .superset/config.json for this repo.
```
...
Delegate in workspaces, review in diffs, integrate through branches and PRs. Everything else in Choros builds on this loop.
