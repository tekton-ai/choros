...
- **Linear** - issues synced from your connected workspace (see [Linear Integration](/use-with-linear)), listed alongside Choros-native tasks you create in the app
...
The point of having tasks in Choros is delegation. Launch an agent from a task and the task's content becomes the agent's prompt:
