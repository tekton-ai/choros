---
title: Choros SDK Reference
description: Method-by-method reference for the Choros TypeScript SDK.
---
...
const client = new Choros({
  ...
  organizationId: '…',
  // optional:
  baseURL: 'https://api.choros.sh',
  relayURL: 'https://relay.choros.sh',
  timeout: 60_000,
  maxRetries: 2,
...
const a = await client.automations.create({
  ...
  agent: 'claude', // host agent presetId, instance UUID, or 'choros' for built-in chat
