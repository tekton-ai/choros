---
title: Custom Themes
description: Build, edit, and import your own Choros theme files
---
...
```text
Customize this Choros theme JSON to feel like a neon cyberpunk arcade.
Keep the schema valid. Preserve all required ui and terminal keys.
Return the full JSON file contents only.
```

Then save the returned JSON and import it in Choros.
...
Missing values fall back to Choros defaults for the selected theme type.
