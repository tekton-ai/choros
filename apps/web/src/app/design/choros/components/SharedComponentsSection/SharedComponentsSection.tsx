...
const DESKTOP_COMPONENTS: SharedComponent[] = [
	{
		...
		sites: 12,
		note: i18n._({
			id: "web.design.sharedComponents.note.canonicalMarkdownSurfaceForAgent",
			message:
	...
	},
	{
		...
		sites: 7,
		note: i18n._({
			id: "web.design.sharedComponents.note.agentPickerClaudeCodexCursor",
			message:
	...
	},
	{
		...
		sites: 5,
		note: i18n._({
			id: "web.design.sharedComponents.note.rendersARegisteredHotkeyInside",
	...
	},
	{
		...
		sites: 5,
		note: i18n._({
			id: "web.design.sharedComponents.note.ghostTriggerIconTruncatingLabel",
			message:
	...
	},
	{
		...
		sites: 3,
		note: i18n._({
			id: "web.design.sharedComponents.note.workspaceAccentColorPicker",
	...
	},
	{
		...
		sites: 2,
		note: i18n._({
			id: "web.design.sharedComponents.note.longHoverShortcutOnlyTooltip",
			message:
	...
	},
	{
		...
		sites: 2,
		note: i18n._({
			id: "web.design.sharedComponents.note.textInputWithEmojiPicker",
	...
	},
	{
		...
		sites: 2,
		note: i18n._({
			id: "web.design.sharedComponents.note.terminalThemeColorPalettePreview",
	...
	},
	{
		...
		sites: 2,
		note: i18n._({
			id: "web.design.sharedComponents.note.sidebarPillShownWhenAn",
	...
	},
	{
		...
		note: i18n._({
			id: "web.design.sharedComponents.note.splitButtonOpenWorktreeIn",
			message:
	...
	},
	{
		...
		note: i18n._({
			id: "web.design.sharedComponents.note.modelPickerScopedToThe",
	...
	},
	{
		...
		note: i18n._({
			id: "web.design.sharedComponents.note.markdownAuthoringSurfaceWithPreview",
...
const PACKAGE_COMPONENTS: SharedComponent[] = [
	{
		...
		note: i18n._({
			id: "web.design.sharedComponents.note.paneLayoutRootRendersA",
	...
	},
	{
		...
		note: i18n._({
			id: "web.design.sharedComponents.note.standardActionStripForPane",
...
export function SharedComponentsSection() {
	return (
		<ShowcaseSection
			...
			index="06"
			title={i18n._({
				id: "web.design.sharedComponentsSection.sharedAppComponents",
				message: "Shared app components",
			})}
			description={i18n._({
				id: "web.design.sharedComponentsSection.crossFeatureComponentsLivingOutside",
				message:
		...
		>
			<ComponentCard
				title={i18n._({
					id: "web.design.sharedComponentsSection.desktopRenderer",
					message: "Desktop renderer",
				})}
				importPath="apps/desktop/src/renderer/components/*"
				copyable={false}
				description={i18n._({
					id: "web.design.sharedComponentsSection.electronTrpcCoupledSoReferenced",
					message:
