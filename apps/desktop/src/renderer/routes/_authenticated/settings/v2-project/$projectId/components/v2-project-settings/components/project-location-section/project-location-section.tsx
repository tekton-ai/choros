...
import { RemotePathPicker } from "renderer/components/remote-path-picker";
...
import { ClickablePath } from "../../../../../../components/clickable-path";
import { SetupProjectModal } from "../setup-project-modal";
