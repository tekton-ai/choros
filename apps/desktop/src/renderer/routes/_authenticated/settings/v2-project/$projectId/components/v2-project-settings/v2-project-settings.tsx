...
} from "renderer/hooks/host-projects/resolve-project-icon-url";
...
import { useWorkspaceHostOptions } from "renderer/routes/_authenticated/components/dashboard-new-workspace-modal/components/dashboard-new-workspace-form/components/device-picker/hooks/use-workspace-host-options";
...
} from "../../../../components/host-select";
import { SettingsRow } from "../../../../components/settings-row";
import { SettingsSection } from "../../../../components/settings-section";
import { BranchPrefixSection } from "./components/branch-prefix-section";
import { DeleteProjectSection } from "./components/delete-project-section";
import { IconUploadField } from "./components/icon-upload-field";
import { NameSection } from "./components/name-section";
import { NamingInstructionsSection } from "./components/naming-instructions-section";
...
import { SparseCheckoutSection } from "./components/sparse-checkout-section";
import { V2ScriptsEditor } from "./components/v2-scripts-editor";
import { WorktreeLocationSection } from "./components/worktree-location-section";
