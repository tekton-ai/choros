...
import { PresetEditorDialog } from "../presets-section/components/preset-editor-dialog";

import { PresetsTable } from "../presets-section/components/presets-table";
import {
	type QuickAddAgentPill,
	QuickAddPresets,
} from "../presets-section/components/quick-add-presets";
import type { AutoApplyField } from "../presets-section/constants";
import type { PresetProjectOption } from "../presets-section/preset-project-options";
...
export function V2PresetsSection({
	...
	// V2TerminalPresetRow is a choros of TerminalPreset — safe to cast
