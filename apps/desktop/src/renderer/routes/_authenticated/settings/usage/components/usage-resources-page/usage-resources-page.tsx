...
import { UsageSeverityBadge } from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/components/usage-severity-badge";
import { useResourceNavigation } from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/hooks/use-resource-navigation";
import { useResourceSnapshot } from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/hooks/use-resource-snapshot";
import type {
	ResourceMetricsSnapshot,
	SortOption,
} from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/types";
import {
	formatCpu,
	formatMemory,
	formatPercent,
} from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/utils/formatters";
import {
	getTrackedHostMemorySeverity,
	getUsageSeverity,
} from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/utils/resource-severity";
import {
	groupWorkspacesByProject,
	sortProjectGroups,
	sortWorkspaces,
} from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/resource-consumption/utils/workspace-grouping";
import { ResourceSparkline } from "./components/resource-sparkline";
import { useResourceSampleBuffer } from "./hooks/use-resource-sample-buffer";
