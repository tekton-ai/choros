...
import { AnthropicOAuthDialog } from "renderer/components/provider-auth/components/anthropic-oauth-dialog";
import { OpenAIOAuthDialog } from "renderer/components/provider-auth/components/openai-oauth-dialog";
import { useAnthropicOAuth } from "renderer/components/provider-auth/hooks/use-anthropic-oauth";
import { useOpenAIOAuth } from "renderer/components/provider-auth/hooks/use-openai-oauth";
import { SettingsSection } from "renderer/routes/_authenticated/settings/components/settings-section";
import {
	isItemVisible,
	SETTING_ITEM_ID,
	type SettingItemId,
		...
		return (
			...
			>
				{action.kind === "reconnect" ? (
					<Trans id="settings.models.reconnect">Reconnect</Trans>
				) : (
					<Trans id="settings.models.signIn">Sign in</Trans>
				)}
			</Button>
		);
	};
			...
			<div className="w-full max-w-4xl p-6">
				<div className="mb-8">
					<h2 className="text-xl font-semibold">
						<Trans id="settings.models.title">Models</Trans>
					</h2>
					<p className="mt-1 text-sm text-muted-foreground">
						<Trans id="settings.models.subtitle">
							...
							<Collapsible open={advancedOpen} onOpenChange={setAdvancedOpen}>
								<div className="flex items-center justify-between">
									<CollapsibleTrigger asChild>
										...
										>
											...
											/>
											<Trans id="settings.models.advanced">Advanced</Trans>
										</button>
									</CollapsibleTrigger>
									{advancedOpen && hasAdvancedContent ? (
										...
										>
											<Trans id="settings.models.advancedReset">Reset</Trans>
										</button>
									) : null}
								</div>
								<CollapsibleContent className="mt-3 space-y-3">
									<div className="space-y-1.5">
										...
										>
											<Trans id="settings.models.authToken">Auth token</Trans>
										</Label>
										<Input
									...
									<div className="space-y-1.5">
										<Label
											...
											className="text-sm font-medium"
										>
											<Trans id="settings.models.baseUrl">Base URL</Trans>
										</Label>
										<Input
									...
									<div className="space-y-1.5">
										<Label
											...
											className="text-sm font-medium"
										>
											<Trans id="settings.models.extraEnv">
												Additional env vars
											</Trans>
										</Label>
										<Textarea
									...
									<p className="text-xs text-muted-foreground">
										<Trans id="settings.models.savedOnBlur">
											Saved on blur.
										</Trans>
									</p>
								</CollapsibleContent>
