...
import { browserRuntimeRegistry } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-pane-registry/components/browser-pane/browser-runtime-registry";
import {
	extractPaneIds,
	type PaneLifecycleRow,
} from "renderer/routes/_authenticated/components/utils/pane-lifecycle-rows";
...
import type { AppCollections } from "renderer/routes/_authenticated/providers/collections-provider/collections";
import {
	getNextTabOrder,
	getPrependTabOrder,
