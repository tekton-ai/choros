...
import { useDashboardSidebarHoverActions } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/providers/dashboard-sidebar-hover-provider";
