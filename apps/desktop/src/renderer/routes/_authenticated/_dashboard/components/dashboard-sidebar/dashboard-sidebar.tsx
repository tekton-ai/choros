...
import {
	SidebarCardSlot,
	useStarNagCard,
} from "renderer/components/sidebar-card-slot";
import { UpdatesPill } from "renderer/components/updates-pill";
import { useHotkeyDisplay } from "renderer/hotkeys";
import { OrganizationDropdown } from "renderer/routes/_authenticated/_dashboard/components/top-bar/components/organization-dropdown";
...
import { DashboardSidebarProjectSection } from "./components/dashboard-sidebar-project-section";
import { DashboardSidebarSectionRenameProvider } from "./components/dashboard-sidebar-section-rename-context";
import { DashboardSidebarSessionsSection } from "./components/dashboard-sidebar-sessions-section";
import { DashboardSidebarWorkspacesHeader } from "./components/dashboard-sidebar-workspaces-header";
import { SectionDragSpacer } from "./components/section-drag-spacer";
import { useV2SetupScriptCard } from "./components/v2-setup-script-card";
import { useDashboardSidebarData } from "./hooks/use-dashboard-sidebar-data";
import { useDashboardSidebarShortcuts } from "./hooks/use-dashboard-sidebar-shortcuts";
import { useMigrateLegacySidebarFolders } from "./hooks/use-migrate-legacy-sidebar-folders";
						...
						<DashboardSidebarHoverCardOverlay>
							...
							>
								<div className="flex h-full flex-col border-r border-border bg-sidebar dark:bg-muted/35">
									...
									<SidebarCardSlot
										isCollapsed={isCollapsed}
										entries={[setupScriptCard, starNagCard]}
									/>
									<div
										className={cn(
											isCollapsed
