...
import { getStatusTooltip } from "renderer/screens/main/components/status-indicator";
import type {
	DashboardSidebarRunningAgent,
	RunningAgentStatus,
} from "../../../../hooks/use-dashboard-sidebar-workspace-running-agents";
import { DashboardSidebarAgentAvatar } from "../dashboard-sidebar-agent-avatar";
