...
import { WorkspaceNameMarquee } from "renderer/components/workspace-name-marquee";
import type { DiffStats } from "renderer/hooks/host-service/use-diff-stats";
import { useFocusVisible } from "renderer/hooks/use-focus-visible";
...
import { DashboardSidebarWorkspaceDiffStats } from "../dashboard-sidebar-workspace-diff-stats";
import { DashboardSidebarWorkspaceIcon } from "../dashboard-sidebar-workspace-icon";
import { DashboardSidebarWorkspaceChips } from "./components/dashboard-sidebar-workspace-chips";
...
>(
	(
		...
		const { name, branch, pullRequest, pendingTransaction } = workspace;
		...
		// the context menu.
		const isLocalMainWorkspace = isMainWorkspace;
