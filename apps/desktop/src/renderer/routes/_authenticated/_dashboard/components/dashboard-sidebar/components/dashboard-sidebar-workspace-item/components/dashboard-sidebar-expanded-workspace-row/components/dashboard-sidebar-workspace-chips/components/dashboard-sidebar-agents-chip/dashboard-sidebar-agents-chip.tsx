...
import { useDashboardSidebarChipHoverSuppression } from "../../hooks/use-dashboard-sidebar-chip-hover-suppression";
import type { DashboardSidebarRunningAgent } from "../../hooks/use-dashboard-sidebar-workspace-running-agents";
import { DashboardSidebarAgentAvatar } from "./components/dashboard-sidebar-agent-avatar";
import { DashboardSidebarAgentHoverRow } from "./components/dashboard-sidebar-agent-hover-row";
