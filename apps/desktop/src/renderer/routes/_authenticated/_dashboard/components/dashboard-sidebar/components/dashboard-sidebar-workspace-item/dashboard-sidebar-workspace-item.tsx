...
import { RenameBranchDialog } from "renderer/screens/main/components/workspace-sidebar/workspace-list-item/components";
import {
	useDashboardSidebarHoverActions,
	useDashboardSidebarIsHovered,
} from "../../providers/dashboard-sidebar-hover-provider";
import type { WorkspaceSelectionEvent } from "../../providers/dashboard-sidebar-selection-provider";
import { useSidebarWorkspaceStatus } from "../../providers/dashboard-sidebar-workspace-status-provider";
import type {
	DashboardSidebarWorkspace,
	DashboardSidebarWorkspaceIndentation,
} from "../../types";
import { DashboardSidebarCollapsedWorkspaceButton } from "./components/dashboard-sidebar-collapsed-workspace-button";
import { DashboardSidebarExpandedWorkspaceRow } from "./components/dashboard-sidebar-expanded-workspace-row";
import {
	DashboardSidebarWorkspaceBulkContextMenu,
	useWorkspaceRowContextMenu,
} from "./components/dashboard-sidebar-workspace-bulk-context-menu";
import { DashboardSidebarWorkspaceContextMenu } from "./components/dashboard-sidebar-workspace-context-menu/dashboard-sidebar-workspace-context-menu";
import { useDashboardSidebarWorkspaceItemActions } from "./hooks/use-dashboard-sidebar-workspace-item-actions";
