...
} from "renderer/hooks/host-service/use-destroy-workspace";
import { useV2UserPreferences } from "renderer/hooks/use-v2-user-preferences/use-v2-user-preferences";
import { useNavigateAwayFromWorkspace } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/hooks/use-navigate-away-from-workspace";
import type { DashboardSidebarWorkspace } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/types";
