...
import type { DashboardSidebarPortGroup } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/hooks/use-dashboard-sidebar-ports-data";
...
import { TopBarPortRow } from "../top-bar-port-row";
