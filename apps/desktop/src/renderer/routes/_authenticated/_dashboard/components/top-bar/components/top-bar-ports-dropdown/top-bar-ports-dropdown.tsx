...
import { useDashboardSidebarAllPorts } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/providers/dashboard-sidebar-ports-provider";
...
import { TopBarPortsFooter } from "./components/top-bar-ports-footer";
import { TopBarPortsGroup } from "./components/top-bar-ports-group";
...
export function TopBarPortsDropdown({
	...
	if (portsDisplayMode !== "topbar" || totalPortCount === 0) return null;
