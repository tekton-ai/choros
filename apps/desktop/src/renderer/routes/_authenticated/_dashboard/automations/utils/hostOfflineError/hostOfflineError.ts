...
export const HOST_OFFLINE_HELP = msg({
	...
	message:
		"The host isn't connected to the Choros relay. If it's this device, turn on \"Allow remote access to this device via relay\" in Settings > Remote Access, then try again.",
});
