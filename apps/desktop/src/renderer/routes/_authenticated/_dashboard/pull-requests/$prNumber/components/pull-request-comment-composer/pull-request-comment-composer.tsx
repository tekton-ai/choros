...
import { useV2AgentConfigs } from "renderer/hooks/use-v2-agent-configs";
import { AgentPickerSelect } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-pane-registry/components/agent-comment-composer/components/agent-picker-select";
import {
	type AgentTarget,
	useDiffCommentTarget,
} from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-pane-registry/components/agent-comment-composer/hooks/use-diff-comment-target";

export type { AgentTarget } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-pane-registry/components/agent-comment-composer/hooks/use-diff-comment-target";
