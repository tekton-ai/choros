...
import { useSendToTerminalAgent } from "renderer/hooks/host-service/use-send-to-terminal-agent";
...
} from "../../../agent-comment-composer";
import {
	buildDesignModePrompt,
	shortDesignModeElementLabel,
} from "../../design-mode-prompt";
import { writeDesignModeAttachments } from "../../write-design-mode-attachments";
