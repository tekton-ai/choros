...
import { useGitStatusMap } from "renderer/hooks/host-service/use-git-status-map";
import {
	ShadowClickHint,
...
import { PierreRowContextMenu } from "../pierre-row-context-menu";
import { FileMenuItems } from "./components/file-menu-items";
import { FilesTabDropOverlay } from "./components/files-tab-drop-overlay";
import { FilesTabHeaderButton } from "./components/files-tab-header-button";
import { FolderMenuItems } from "./components/folder-menu-items";
import {
	FILE_EXPLORER_INDENT,
	FILE_EXPLORER_OVERSCAN,
	FILE_EXPLORER_ROW_HEIGHT,
} from "./constants";
import { useFileTreeScrollFade } from "./hooks/use-file-tree-scroll-fade";
import { useFilesTabActions } from "./hooks/use-files-tab-actions";
import { useFilesTabBridge } from "./hooks/use-files-tab-bridge";
import { useFilesTabDrop } from "./hooks/use-files-tab-drop";
import { buildPierreGitStatus } from "./utils/build-pierre-git-status";
import { stripTrailingSlash, toAbs, toRel } from "./utils/tree-path";
