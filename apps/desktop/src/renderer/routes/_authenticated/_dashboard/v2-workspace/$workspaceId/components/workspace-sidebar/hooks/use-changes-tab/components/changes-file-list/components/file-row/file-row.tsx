...
import { StatusIndicator } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/components/status-indicator";
import { PathActionsMenuItems } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/components/workspace-sidebar/components/path-actions-menu-items";
import {
	type ChangesetFile,
	getChangesetFileKey,
