...
} from "renderer/lib/click-policy";
import {
	type ConnectionState,
	terminalRuntimeRegistry,
} from "renderer/lib/terminal/terminal-runtime-registry";
import { electronTrpcClient } from "renderer/lib/trpc-client";
import { useOpenInExternalEditor } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-open-in-external-editor";
import { useRevealInFinder } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-reveal-in-finder";
import type {
	PaneViewerData,
	TerminalPaneData,
} from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/types";
import { openUrlInV2Workspace } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/utils/open-url-in-v2-workspace";
import { useWorkspaceWsUrl } from "renderer/routes/_authenticated/_dashboard/v2-workspace/providers/workspace-trpc-provider/workspace-trpc-provider";
...
import { TerminalAgentAutoResume } from "./components/terminal-agent-auto-resume";
import { TerminalCopiedIndicator } from "./components/terminal-copied-indicator";
import { TerminalRichInput } from "./components/terminal-rich-input";
import { TerminalSearch } from "./components/terminal-search";
import { useCopyOnSelect } from "./hooks/use-copy-on-select";
import { useLinkClickHint } from "./hooks/use-link-click-hint";
import {
	type HoveredLink,
	useLinkHoverState,
} from "./hooks/use-link-hover-state";
import { useTerminalAppearance } from "./hooks/use-terminal-appearance";
import { useTerminalInterruptClear } from "./hooks/use-terminal-interrupt-clear";
import {
	terminalRichInputOpenStore,
	useTerminalRichInputOpen,
} from "./rich-input-open-store";
import {
	PasteUploadLimitError,
	uploadPastedFiles,
} from "./upload-pasted-files";
