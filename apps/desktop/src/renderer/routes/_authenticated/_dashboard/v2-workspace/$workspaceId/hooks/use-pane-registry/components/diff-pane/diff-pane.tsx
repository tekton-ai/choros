...
import {
	...
	getPaneScrollState,
	savePaneScrollState,
} from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/state/pane-scroll-state-cache";
import { MarkdownSearch } from "renderer/screens/main/components/workspace-view/content-view/tabs-content/tab-view/file-viewer-pane/components/markdown-search";
...
import { useOpenInExternalEditor } from "../../../use-open-in-external-editor";
import { useSidebarDiffRef } from "../../../use-sidebar-diff-ref";
import { useViewedFiles } from "../../../use-viewed-files";
import { AgentCommentComposer } from "../agent-comment-composer";
import { CommentThread } from "./components/comment-thread";
import { DeferredDiffPlaceholder } from "./components/deferred-diff-placeholder";
import { DiffHeaderMetadata } from "./components/diff-header-metadata";
import { DiffHeaderPrefix } from "./components/diff-header-prefix";
import { DiffSectionBar } from "./components/diff-section-bar";
import { useDiffActiveSection } from "./hooks/use-diff-active-section";
import {
	type DiffAnnotationMetadata,
	useDiffAnnotationsByPath,
} from "./hooks/use-diff-annotations";
import { useDiffCodeViewItems } from "./hooks/use-diff-code-view-items";
import { useDiffCodeViewScroll } from "./hooks/use-diff-code-view-scroll";
import { useDiffCodeViewTheme } from "./hooks/use-diff-code-view-theme";
import { useDiffCommentComposer } from "./hooks/use-diff-comment-composer";
import { useDiffPaneSearch } from "./hooks/use-diff-pane-search";
import { createGetDiffInput } from "./utils/create-get-diff-input";
import { isDiffContentTooLarge } from "./utils/diff-loading-guards";
import { getCharacterOffsetAtClientX } from "./utils/get-character-offset-at-client-x";
