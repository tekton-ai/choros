...
import type { TerminalLauncher } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-v2-terminal-launcher";
import type {
	PaneViewerData,
	TerminalPaneData,
} from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/types";
import { useCollections } from "renderer/routes/_authenticated/providers/collections-provider";
import { TerminalPaneIcon } from "../terminal-pane-icon";
import {
	getTerminalDisplayTitle,
	getTerminalSessionListRefetchInterval,
	shouldQueryTerminalSessionList,
	TERMINAL_SESSION_LIST_STALE_MS,
} from "./terminal-session-dropdown.utils";
...
function formatCreatedAt(createdAt: number | undefined): string {
	...
	return formatCompactRelativeTime(createdAt);
}
