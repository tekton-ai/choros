...
import { DEFAULT_CODE_EDITOR_FONT_SIZE } from "renderer/screens/main/components/workspace-view/components/code-editor/constants";
import {
	DIFF_POOL_RENDER_OPTIONS,
	getDiffsTheme,
	getDiffViewerStyle,
} from "renderer/screens/main/components/workspace-view/utils/code-theme";
