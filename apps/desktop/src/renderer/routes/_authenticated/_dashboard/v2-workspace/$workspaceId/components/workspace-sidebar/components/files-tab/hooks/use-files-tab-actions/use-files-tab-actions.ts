...
} from "../../utils/creation-paths";
import type {
	ProvisionalEntry,
	ProvisionalEvent,
} from "../../utils/provisional-entry";
import { reduceProvisional } from "../../utils/provisional-entry";
import { scrollTreeToRow } from "../../utils/scroll-tree-to-row";
import {
	asDirectoryHandle,
	parentRel,
	stripTrailingSlash,
	toAbs,
	toRel,
} from "../../utils/tree-path";
import type { FilesTabBridge } from "../use-files-tab-bridge";
