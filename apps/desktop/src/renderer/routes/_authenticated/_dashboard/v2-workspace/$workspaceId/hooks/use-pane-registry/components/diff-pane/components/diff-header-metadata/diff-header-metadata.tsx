...
import { useSidebarFilePolicy } from "renderer/lib/click-policy";
...
import type { ChangesetFile } from "../../../../../use-changeset";
import { useDiffHeaderHover } from "../../hooks/use-diff-header-hover";
