	...
	return (
		<div className="absolute top-1 right-1 z-10 flex items-center max-w-[calc(100%-0.5rem)] rounded bg-popover/95 pl-2 pr-0.5 shadow-lg ring-1 ring-border/40 backdrop-blur">
			<input
				...
				placeholder={t({
					id: "workspace.terminal.search.placeholder",
					message: "Find",
				})}
			...
			{matchCount === 0 && query && (
				<span className="text-xs text-muted-foreground whitespace-nowrap px-1">
					<Trans id="workspace.terminal.search.noResults">No results</Trans>
				</span>
			)}
			<div className="flex items-center shrink-0">
				<Tooltip>
					...
					<TooltipContent side="bottom">
						<Trans id="workspace.terminal.search.matchCase">Match case</Trans>
					</TooltipContent>
				</Tooltip>
				<Tooltip>
					<TooltipTrigger asChild>
					...
					<TooltipContent side="bottom">
						<Trans id="workspace.terminal.search.previous">
				...
				<Tooltip>
					...
					<TooltipContent side="bottom">
						<Trans id="workspace.terminal.search.next">Next (Enter)</Trans>
					</TooltipContent>
				</Tooltip>
				<Tooltip>
					<TooltipTrigger asChild>
					...
					<TooltipContent side="bottom">
						<Trans id="workspace.terminal.search.close">Close (Esc)</Trans>
					</TooltipContent>
				</Tooltip>
			</div>
		</div>
