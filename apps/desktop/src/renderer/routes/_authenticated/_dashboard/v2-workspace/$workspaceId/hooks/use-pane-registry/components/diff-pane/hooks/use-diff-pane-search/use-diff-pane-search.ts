...
import { getDiffSearchRoots } from "renderer/screens/main/components/workspace-view/content-view/tabs-content/tab-view/file-viewer-pane/utils/diff-renderer-roots";
import type { UseTextSearchReturn } from "renderer/screens/main/components/workspace-view/content-view/tabs-content/tab-view/hooks";
import {
	findTextRanges,
	type HighlightStyleElementMap,
	type SearchRootIndexCache,
	syncHighlightStyles,
} from "renderer/screens/main/components/workspace-view/content-view/tabs-content/tab-view/hooks/use-text-search/utils/text-search-dom";
import { useSettings } from "renderer/stores/settings";
import {
	type ChangesetFile,
	getChangesetFileKey,
} from "../../../../../use-changeset";
import type { DiffAnnotationMetadata } from "../use-diff-annotations";
import {
	collectDiffSearchMatches,
	type DiffSearchMatch,
} from "./utils/collect-diff-search-matches";
