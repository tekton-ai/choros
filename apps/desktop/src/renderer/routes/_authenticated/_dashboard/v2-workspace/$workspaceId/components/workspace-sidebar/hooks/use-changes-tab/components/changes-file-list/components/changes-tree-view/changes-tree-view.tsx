...
import { useFallthroughIcons } from "renderer/lib/file-icons";
import {
	...
	stripTrailingSlash,
} from "renderer/lib/pierre-tree";
import { DiscardConfirmDialog } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/components/discard-confirm-dialog";
import { PierreRowContextMenu } from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/components/workspace-sidebar/components/pierre-row-context-menu";
import {
	type ChangesetFile,
	getChangesetFileKey,
} from "renderer/routes/_authenticated/_dashboard/v2-workspace/$workspaceId/hooks/use-changeset";
import {
	toAbsoluteWorkspacePath,
	toRelativeWorkspacePath,
} from "shared/absolute-paths";
import type { FoldSignal } from "../../changes-file-list";
import { setFileDragData } from "../../hooks/use-file-drag";
import { FileRowContextMenuItems } from "./components/file-row-context-menu-items";
import { FolderContextMenuItems } from "./components/folder-context-menu-items";
import { ShadowRowHoverActions } from "./components/shadow-row-hover-actions";
import { useMeasuredTreeHeight } from "./hooks/use-measured-tree-height";
import { buildCollisionSafeTreePaths } from "./utils/build-collision-safe-tree-paths";
import { buildTreeShape } from "./utils/build-tree-shape";
