...
import { BoardColumnIcon } from "renderer/routes/_authenticated/_dashboard/v2-workspaces/components/board-column-icon";
import type {
	V2WorkspaceHostOption,
	V2WorkspaceProjectOption,
} from "renderer/routes/_authenticated/_dashboard/v2-workspaces/hooks/use-accessible-v2-workspaces";
import {
...
import { BOARD_COLUMN_LABELS } from "renderer/routes/_authenticated/_dashboard/v2-workspaces/utils/derive-board-column";
...
import { DeviceOptionLabel } from "./components/device-option-label";
