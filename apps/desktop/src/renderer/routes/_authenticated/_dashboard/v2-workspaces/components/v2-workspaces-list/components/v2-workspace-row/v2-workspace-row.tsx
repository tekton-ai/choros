...
import { workspaceActivityAt } from "renderer/routes/_authenticated/_dashboard/v2-workspaces/utils/sort-workspaces";
import { PRIcon } from "renderer/screens/main/components/pr-icon/pr-icon";
import { WorkspaceStateGlyph } from "./components/workspace-state-glyph";
...
export function V2WorkspaceRow({
	...
	const timeLabel = formatCompactRelativeTime(workspaceActivityAt(workspace));
