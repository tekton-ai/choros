...
import { useAgentEffortPreference } from "renderer/hooks/use-agent-effort-preference";
import { useAgentLaunchPreferences } from "renderer/hooks/use-agent-launch-preferences";
...
} from "../../hooks/use-new-workspace-prompt-cards-variant";
import { DevicePicker } from "../dashboard-new-workspace-form/components/device-picker";
import { useWorkspaceHostOptions } from "../dashboard-new-workspace-form/components/device-picker/hooks/use-workspace-host-options";
import { CompareBaseBranchPicker } from "../dashboard-new-workspace-form/prompt-group/components/compare-base-branch-picker";
import { GitHubIssueLinkCommand } from "../dashboard-new-workspace-form/prompt-group/components/github-issue-link-command";
import { LinkedGitHubIssuePill } from "../dashboard-new-workspace-form/prompt-group/components/linked-github-issue-pill";
import { LinkedPRPill } from "../dashboard-new-workspace-form/prompt-group/components/linked-pr-pill";
import { PRLinkCommand } from "../dashboard-new-workspace-form/prompt-group/components/pr-link-command";
import { ProjectPickerPill } from "../dashboard-new-workspace-form/prompt-group/components/project-picker-pill";
import { PromptHistoryCommand } from "../dashboard-new-workspace-form/prompt-group/components/prompt-history-command";
import { useBranchPickerController } from "../dashboard-new-workspace-form/prompt-group/hooks/use-branch-picker-controller";
import { useLinkedContext } from "../dashboard-new-workspace-form/prompt-group/hooks/use-linked-context";
import { useSubmitWorkspace } from "../dashboard-new-workspace-form/prompt-group/hooks/use-submit-workspace";
import {
	useFileIdsForHost,
	useUploadAttachments,
} from "../dashboard-new-workspace-form/prompt-group/hooks/use-upload-attachments";
import {
	AGENT_STORAGE_KEY,
	EFFORT_STORAGE_KEY,
	MODE_STORAGE_KEY,
...
import { PROMPT_PLACEHOLDERS } from "./components/sample-prompts/constants";
import { useSamplePromptSelection } from "./hooks/use-sample-prompt-selection";
...
export function NewWorkspaceScreen({
	...
	}, [draft.hostId, machineId, activeHostUrl]);
