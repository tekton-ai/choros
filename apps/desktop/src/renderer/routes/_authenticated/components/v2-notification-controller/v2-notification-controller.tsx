...
} from "./components/host-notification-subscriber";
import { markV2AgentLifecycleTargetSeen } from "./lib/lifecycle-events";
...
export function V2NotificationController() {
	...
	const hostGroups = useMemo(
		...
		[workspaceHosts, workspaceStatesById, machineId, activeHostUrl],
	);
...
function getHostUrlForWorkspace({
	...
	return machineId && hostId === machineId ? activeHostUrl : null;
}
