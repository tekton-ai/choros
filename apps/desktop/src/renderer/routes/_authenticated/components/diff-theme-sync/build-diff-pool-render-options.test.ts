...
import { getDiffsTheme } from "renderer/screens/main/components/workspace-view/utils/code-theme";
import { darkTheme, monokaiTheme } from "shared/themes";
import { buildDiffPoolRenderOptions } from "./build-diff-pool-render-options";
