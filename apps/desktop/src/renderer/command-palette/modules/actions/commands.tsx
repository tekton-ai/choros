...
const PREVIEW_NOTICES = {
	info: {
		...
		severity: "info",
		trigger: "immediate",
		body: "### New in this version\n\nThis is a **preview** of an info notice. Markdown, [links](https://choros.sh), and images render here.",
		cta: {
			label: "Read the changelog",
			action: "open-url",
			url: "https://choros.sh/changelog",
		},
		dismissible: true,
	},
	warning: {
