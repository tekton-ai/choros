...
import { previewStarNagOnboardingToast } from "renderer/components/star-nag-toast";
...
import { ThemeFrame } from "../../ui/theme-frame/theme-frame";
...
const PREVIEW_NOTICES = {
	info: {
		...
		severity: "info",
		trigger: "immediate",
		body: "### New in this version\n\nThis is a **preview** of an info notice. Markdown, [links](https://tekton-ai.github.io/choros), and images render here.",
		cta: {
			label: "Read the changelog",
			action: "open-url",
			url: "https://tekton-ai.github.io/choros/changelog",
		},
		dismissible: true,
	},
	warning: {
		...
		severity: "warning",
		trigger: "immediate",
		body: "### Heads up: breaking changes ahead\n\nThis is a **preview** of a warning notice about the next version.",
