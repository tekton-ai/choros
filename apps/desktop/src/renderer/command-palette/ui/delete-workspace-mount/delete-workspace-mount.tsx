import { DashboardSidebarDeleteDialog } from "renderer/routes/_authenticated/_dashboard/components/dashboard-sidebar/components/dashboard-sidebar-delete-dialog";
