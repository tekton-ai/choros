...
import type { GithubStarActionState } from "renderer/hooks/use-github-star-action";
import { STAR_SUCCESS_ANIMATION_MS } from "renderer/hooks/use-github-star-action";
import "./animated-star-button.css";
