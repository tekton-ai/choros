		...
		<Collapsible open={showAdvanced} onOpenChange={onShowAdvancedChange}>
			<div className="flex items-center justify-between">
				<CollapsibleTrigger className="flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground transition-colors">
					...
					/>
					<Trans id="components.promptGroupAdvancedOptions.title">
						Advanced options
					</Trans>
				</CollapsibleTrigger>
				{shortcutHint && (
			...
			<CollapsibleContent className="pt-3 space-y-3">
				<div className="space-y-1.5">
					<div className="flex items-center justify-between">
						<label htmlFor="branch" className="text-xs text-muted-foreground">
							<Trans id="components.promptGroupAdvancedOptions.branchName">
								Branch name
							</Trans>
						</label>
						<button
						...
						>
							...
							<span>
								<Trans id="components.promptGroupAdvancedOptions.editPrefix">
									Edit prefix
								</Trans>
							</span>
						</button>
					...
					<Input
						...
						placeholder={t({
							id: "components.promptGroupAdvancedOptions.autoGeneratedPlaceholder",
				...
				{showCompareBaseBranch && (
					<div className="space-y-1.5">
						<span className="text-xs text-muted-foreground">
							<Trans id="components.promptGroupAdvancedOptions.baseBranch">
								Base branch
							</Trans>
						</span>
						{isBranchesError ? (
							<div className="flex items-center gap-2 h-8 px-3 rounded-md border border-destructive/50 bg-destructive/10 text-destructive text-xs">
								<Trans id="components.promptGroupAdvancedOptions.branchesLoadFailed">
							...
							>
									...
									>
										<span className="flex items-center gap-2 truncate">
											...
											<span className="truncate font-mono text-sm">
												{effectiveCompareBaseBranch || (
													<Trans id="components.promptGroupAdvancedOptions.selectBranch">
														Select branch...
													</Trans>
												)}
											</span>
											{effectiveCompareBaseBranch === defaultBranch && (
												<span className="text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded">
													<Trans id="components.promptGroupAdvancedOptions.selectedDefaultBadge">
														default
													</Trans>
												</span>
											)}
								...
								>
									<Command shouldFilter={false}>
										<CommandInput
											placeholder={t({
												id: "components.promptGroupAdvancedOptions.searchBranchesPlaceholder",
										...
										<CommandList className="max-h-[200px]">
											<CommandEmpty>
												<Trans id="components.promptGroupAdvancedOptions.noBranchesFound">
													No branches found
												</Trans>
											</CommandEmpty>
												...
												>
													<span className="flex items-center gap-2 truncate">
														...
														{branch.name === defaultBranch && (
															<span className="text-[10px] text-muted-foreground bg-muted px-1.5 py-0.5 rounded">
																<Trans id="components.promptGroupAdvancedOptions.defaultBranchBadge">
																	default
																</Trans>
															</span>
														)}
				...
				{!hideSetupScript && (
					<div className="flex items-center justify-between">
						...
						>
							<Trans id="components.promptGroupAdvancedOptions.runSetupScript">
								Run setup script
							</Trans>
						</Label>
						<Switch
