...
const STARRED_REPO_PATH = "user/starred/choros-sh/choros";
...
/**
 * Checks whether the signed-in `gh` CLI user has starred choros-sh/choros.
...
/** Stars choros-sh/choros on behalf of the signed-in `gh` CLI user. Never throws. */
