...
- **macOS manifest**: `https://github.com/choros-sh/choros/releases/latest/download/latest-mac.yml`
- **Linux manifest**: `https://github.com/choros-sh/choros/releases/latest/download/latest-linux.yml`
- **macOS installer**: `https://github.com/choros-sh/choros/releases/latest/download/Choros-arm64.dmg`
- **Linux installer**: `https://github.com/choros-sh/choros/releases/latest/download/Choros-x64.AppImage`
