...
<img width="full" alt="Claude và OpenCode làm việc song song trong các workspace Choros với diff trực tiếp" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Tải về cho macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Tài liệu](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros chạy song song các coding agent dạng CLI trong những git worktree cách ly, với terminal, review và luồng mở-trong-editor tích hợp sẵn.
...
[Tài liệu →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude đang stream một cuộc migration billing trong khi các agent khác chạy ở những workspace song song" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Một agent hoàn thành tác vụ và trạng thái trên thanh bên chuyển từ đang làm việc sang xong" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Gõ câu hỏi tiếp theo với một lượt nhắc file bằng @ trong trình soạn prompt phong phú cạnh terminal được chia đôi" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Review thay đổi của một agent trong trình xem diff" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="Trình duyệt trong ứng dụng xem trước một dev server với các cổng được phát hiện" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Các tự động hóa agent theo lịch" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Host và thành viên trong cài đặt tổ chức" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Viết script từ bất kỳ shell nào: tạo workspace, khởi chạy agent, đọc terminal của chúng và quản lý tự động hóa với một binary duy nhất. Nếu một agent chạy được lệnh, nó điều khiển được Choros.

[Tài liệu →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Tạo một workspace và khởi chạy một agent từ Choros CLI" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Tài liệu →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Gõ trong bảng lệnh và lọc trực tiếp các hành động của workspace" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Skill tích hợp](https://docs.choros.sh/skills)**: agent được nạp sẵn các skill `choros:*` (điều phối agent song song, lên lịch tự động hóa, gửi phản hồi, chẩn đoán sự cố), được cung cấp tự động khi khởi chạy
- **[Bộ chọn model & agent tùy chỉnh](https://docs.choros.sh/agent-integration)**: chọn model và mức độ suy luận khi khởi chạy, và thêm bất kỳ terminal agent nào với icon riêng
- **[Script thiết lập workspace](https://docs.choros.sh/setup-teardown-scripts)**: tự động hóa thiết lập env, cài đặt dependency và dev server cho từng workspace
- **[Preset terminal](https://docs.choros.sh/terminal-presets)**: lưu bố cục agent và shell rồi mở chúng bằng một phím bấm
- **[Slack & Linear](https://docs.choros.sh/use-with-linear)**: tạo workspace từ tin nhắn Slack hoặc issue Linear
- **[Mở trong IDE của bạn](https://docs.choros.sh/use-with-ide)**: bàn giao một cú nhấp sang Cursor, VS Code hoặc bất kỳ editor nào
- **[Theme tùy chỉnh](https://docs.choros.sh/custom-themes)**: tạo, chỉnh sửa và nhập file theme
- **[Phím tắt](https://docs.choros.sh/keyboard-shortcuts)**: mọi hành động đều gán lại được qua **Cài đặt → Phím tắt** (⌘/)
- **[Mang provider của riêng bạn](https://docs.choros.sh/providers)**: kết nối OpenRouter, Bedrock, Vertex hoặc Vercel AI Gateway
- **Và còn nhiều nữa**: chúng tôi ship hàng ngày, nên danh sách này luôn bị tụt hậu. [Changelog](https://choros.sh/changelog) mới là danh sách tính năng thật sự.

## Các agent được hỗ trợ

Choros hoạt động với bất kỳ coding agent dạng CLI nào, bao gồm:
...
Nếu nó chạy được trong terminal, nó chạy được trên Choros
...
|:--------|:-------------|
| [**Ứng dụng desktop**](https://github.com/superset-sh/choros/releases/latest) | IDE đầy đủ: terminal, trình xem diff, trình duyệt trong ứng dụng, tự động hóa |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Một binary `choros` duy nhất để quản lý workspace, agent, terminal và host từ bất kỳ shell nào |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | Điều khiển Choros bằng lập trình với [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) từ Node, Bun hoặc Deno |
| [**MCP Server**](https://docs.choros.sh/mcp) | Để Claude Code, Codex, Cursor và các agent khác tự tạo và quản lý workspace |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (thử nghiệm; macOS là nền tảng chính)
- **Windows**: chưa có
- [Tất cả các bản build](https://github.com/superset-sh/choros/releases/latest)

Tất cả những gì bạn cần cài là [Git](https://git-scm.com/). [gh](https://cli.github.com/) là tùy chọn và mở khóa các luồng làm việc PR; Choros sẽ đề nghị cài nó cho bạn.

## Phát triển

Muốn vọc Choros hay đóng góp một PR? Clone repository, thêm nó vào
ứng dụng Choros đã cài, rồi tạo một workspace cho thay đổi của bạn:
...
song song với ứng dụng Choros đã cài và các worktree phát triển khác.
...
bằng nút **"Sign in as dev"** (hoặc `admin@local.test` / `chorosdev`).
...
Cấu hình các script setup, teardown và run của workspace trong `.superset/config.json`. Xem [tài liệu đầy đủ](https://docs.choros.sh/setup-teardown-scripts).
...
Phím tắt có thể tùy chỉnh qua **Cài đặt → Phím tắt** (⌘/); xem [danh sách phím tắt đầy đủ](https://docs.choros.sh/keyboard-shortcuts).
...
Chúng tôi hoan nghênh mọi đóng góp! Xem [CONTRIBUTING.md](../CONTRIBUTING.md) để biết cách thiết lập và mở một PR. Bug và yêu cầu tính năng gửi vào [issues](https://github.com/superset-sh/choros/issues).
...
Tham gia cộng đồng Choros để được trợ giúp, chia sẻ phản hồi và kết nối với những người dùng khác:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: trò chuyện với đội ngũ và cộng đồng
- **[Twitter](https://x.com/choros_sh)**: theo dõi để nhận cập nhật và thông báo
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: báo bug và yêu cầu tính năng
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: đặt câu hỏi và chia sẻ ý tưởng
...
Toàn bộ ứng dụng nằm trong repo này theo giấy phép [Elastic License 2.0](../LICENSE.md): cứ dùng, fork, chỉnh sửa, tự host cho đội ngũ của bạn. Điều duy nhất không được phép là đóng gói lại chính Choros thành dịch vụ bạn bán cho người khác.
