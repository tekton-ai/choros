...
<img width="full" alt="Claude e OpenCode al lavoro in parallelo in workspace Choros con diff in tempo reale" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Scarica per macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Documentazione](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros esegue agenti di coding CLI in parallelo su worktree git isolati, con terminale integrato, revisione delle modifiche e apertura diretta nell'editor.
...
[Documentazione →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude esegue in streaming una migrazione del billing mentre altri agenti lavorano in workspace paralleli" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Un agente termina la sua attività e lo stato nella barra laterale passa da in lavorazione a completato" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Digitazione di un follow-up con una menzione @-file nell'editor di prompt avanzato accanto a un terminale diviso" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Revisione delle modifiche di un agente nel visualizzatore di diff" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="Browser in-app che mostra l'anteprima di un dev server con le porte rilevate" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Automazioni di agenti pianificate" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Host e membri nelle impostazioni dell'organizzazione" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Scriptalo da qualsiasi shell: crea workspace, avvia agenti, leggi i loro terminali e gestisci le automazioni con un singolo binario. Se un agente può eseguire un comando, può pilotare Choros.

[Documentazione →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Creazione di un workspace e avvio di un agente dalla CLI di Choros" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Documentazione →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Digitazione nella palette dei comandi con filtraggio in tempo reale delle azioni del workspace" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Skill integrate](https://docs.choros.sh/skills)**: gli agenti arrivano precaricati con le skill `choros:*` (orchestrare agenti paralleli, pianificare automazioni, inviare feedback, diagnosticare problemi), fornite automaticamente all'avvio
- **[Selettore di modello e agenti personalizzati](https://docs.choros.sh/agent-integration)**: scegli un modello e il livello di ragionamento all'avvio, e aggiungi qualsiasi agente da terminale con la propria icona
- **[Script di setup del workspace](https://docs.choros.sh/setup-teardown-scripts)**: automatizza la configurazione dell'ambiente, l'installazione delle dipendenze e i dev server per ogni workspace
- **[Preset del terminale](https://docs.choros.sh/terminal-presets)**: salva layout di agenti e shell e aprili con un solo tasto
- **[Slack e Linear](https://docs.choros.sh/use-with-linear)**: crea workspace da messaggi Slack o issue Linear
- **[Apri nel tuo IDE](https://docs.choros.sh/use-with-ide)**: passaggio in un clic a Cursor, VS Code o qualsiasi editor
- **[Temi personalizzati](https://docs.choros.sh/custom-themes)**: crea, modifica e importa file di tema
- **[Scorciatoie da tastiera](https://docs.choros.sh/keyboard-shortcuts)**: ogni azione è rimappabile in **Impostazioni → Scorciatoie da tastiera** (⌘/)
- **[Porta i tuoi provider](https://docs.choros.sh/providers)**: collega OpenRouter, Bedrock, Vertex o Vercel AI Gateway
- **E molto altro**: rilasciamo ogni giorno, quindi questa lista è perennemente indietro. Il [changelog](https://choros.sh/changelog) è la vera lista delle funzionalità.

## Agenti supportati

Choros funziona con qualsiasi agente di coding basato su CLI, tra cui:
...
Se gira in un terminale, gira su Choros
...
|:--------|:-------------|
| [**App desktop**](https://github.com/superset-sh/choros/releases/latest) | L'IDE completo: terminali, visualizzatore di diff, browser in-app, automazioni |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Un singolo binario `choros` per gestire workspace, agenti, terminali e host da qualsiasi shell |
| [**SDK TypeScript**](https://docs.choros.sh/sdk/getting-started) | Pilota Choros programmaticamente con [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) da Node, Bun o Deno |
| [**Server MCP**](https://docs.choros.sh/mcp) | Lascia che Claude Code, Codex, Cursor e altri agenti creino e gestiscano i workspace in autonomia |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (sperimentale; macOS è la piattaforma principale)
- **Windows**: non ancora disponibile
- [Tutte le build](https://github.com/superset-sh/choros/releases/latest)

L'unica cosa che serve avere installata è [Git](https://git-scm.com/). [gh](https://cli.github.com/) è opzionale e sblocca i flussi di lavoro per le PR; Choros si offre di installarlo per te.

## Sviluppo

Vuoi lavorare su Choros o contribuire con una PR? Clona il repository, aggiungilo
all'app Choros installata e crea un workspace per la tua modifica:
...
girare accanto all'app Choros installata e agli altri worktree di sviluppo.
...
con il pulsante **"Sign in as dev"** (oppure `admin@local.test` / `chorosdev`).
...
Configura gli script di setup, teardown e run del workspace in `.superset/config.json`. Vedi la [documentazione completa](https://docs.choros.sh/setup-teardown-scripts).
...
Le scorciatoie da tastiera sono personalizzabili in **Impostazioni → Scorciatoie da tastiera** (⌘/); vedi la [lista completa delle scorciatoie](https://docs.choros.sh/keyboard-shortcuts).
...
I contributi sono benvenuti! Vedi [CONTRIBUTING.md](../CONTRIBUTING.md) per come configurare l'ambiente e aprire una PR. Bug e richieste di funzionalità vanno nelle [issue](https://github.com/superset-sh/choros/issues).
...
Unisciti alla community di Choros per ricevere aiuto, condividere feedback e connetterti con altri utenti:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: chatta con il team e la community
- **[Twitter](https://x.com/choros_sh)**: seguici per aggiornamenti e annunci
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: segnala bug e richiedi funzionalità
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: fai domande e condividi idee
...
L'intera app è in questo repo sotto la [Elastic License 2.0](../LICENSE.md): usala, forkala, modificala, ospitala per il tuo team. L'unica cosa esclusa è riconfezionare Choros stesso come servizio da vendere ad altri.
