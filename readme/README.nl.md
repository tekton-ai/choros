...
<img width="full" alt="Claude en OpenCode werken parallel in Choros-werkruimtes met live diffs" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Download voor macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Documentatie](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros draait CLI-gebaseerde coding agents parallel in geïsoleerde git-worktrees, met ingebouwde workflows voor terminal, review en openen-in-editor.
...
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude streamt een billing-migratie terwijl andere agents in parallelle werkruimtes draaien" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Een agent die zijn taak afrondt terwijl de status in de zijbalk omslaat van bezig naar klaar" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Een vervolgvraag typen met een @-bestandsvermelding in de rijke prompteditor naast een gesplitste terminal" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="De wijzigingen van een agent reviewen in de diff-viewer" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="In-app browser met een preview van een dev-server met gedetecteerde poorten" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Geplande agent-automatiseringen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Hosts en leden in organisatie-instellingen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Script het vanuit elke shell: maak werkruimtes aan, start agents, lees hun terminals en beheer automatiseringen met één binary. Als een agent een commando kan uitvoeren, kan hij Choros aansturen.

[Docs →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Een werkruimte aanmaken en een agent starten vanuit de Choros CLI" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Typen in het commandopalet en live werkruimte-acties filteren" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Ingebouwde skills](https://docs.choros.sh/skills)**: agents komen voorgeladen met `choros:*`-skills (parallelle agents orkestreren, automatiseringen inplannen, feedback indienen, problemen diagnosticeren), automatisch klaargezet bij de start
- **[Modelkiezer & aangepaste agents](https://docs.choros.sh/agent-integration)**: kies bij de start een model en redeneerinspanning, en voeg elke terminal-agent toe met een eigen icoon
- **[Setup-scripts voor werkruimtes](https://docs.choros.sh/setup-teardown-scripts)**: automatiseer env-setup, dependency-installaties en dev-servers per werkruimte
- **[Terminal-presets](https://docs.choros.sh/terminal-presets)**: sla agent- en shell-layouts op en open ze met één toetsaanslag
- **[Slack & Linear](https://docs.choros.sh/use-with-linear)**: start werkruimtes vanuit Slack-berichten of Linear-issues
- **[Openen in je IDE](https://docs.choros.sh/use-with-ide)**: overdracht in één klik naar Cursor, VS Code of elke andere editor
- **[Aangepaste thema's](https://docs.choros.sh/custom-themes)**: bouw, bewerk en importeer themabestanden
- **[Sneltoetsen](https://docs.choros.sh/keyboard-shortcuts)**: elke actie is opnieuw toewijsbaar via **Instellingen → Sneltoetsen** (⌘/)
- **[Gebruik je eigen providers](https://docs.choros.sh/providers)**: verbind OpenRouter, Bedrock, Vertex of Vercel AI Gateway
- **En nog veel meer**: we shippen dagelijks, dus deze lijst loopt altijd achter. De [changelog](https://choros.sh/changelog) is de echte featurelijst.

## Ondersteunde agents

Choros werkt met elke CLI-gebaseerde coding agent, waaronder:
...
Als het in een terminal draait, draait het op Choros
...
|:--------|:-------------|
| [**Desktop-app**](https://github.com/superset-sh/choros/releases/latest) | De volledige IDE: terminals, diff-viewer, in-app browser, automatiseringen |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Eén `choros`-binary om werkruimtes, agents, terminals en hosts vanuit elke shell te beheren |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | Stuur Choros programmatisch aan met [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) vanuit Node, Bun of Deno |
| [**MCP-server**](https://docs.choros.sh/mcp) | Laat Claude Code, Codex, Cursor en andere agents zelf werkruimtes aanmaken en beheren |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (experimenteel; macOS is het primaire doelplatform)
- **Windows**: nog niet beschikbaar
- [Alle builds](https://github.com/superset-sh/choros/releases/latest)

Het enige dat je geïnstalleerd moet hebben is [Git](https://git-scm.com/). [gh](https://cli.github.com/) is optioneel en ontgrendelt de PR-workflows; Choros biedt aan het voor je te installeren.

## Ontwikkeling

Wil je aan Choros sleutelen of een PR bijdragen? Cloneer de repository, voeg hem toe aan de
geïnstalleerde Choros-app en maak een werkruimte aan voor je wijziging:
...
Choros-app en andere development-worktrees kan draaien.
...
met de knop **"Sign in as dev"** (of `admin@local.test` / `chorosdev`).
...
Configureer setup-, teardown- en run-scripts voor werkruimtes in `.superset/config.json`. Zie de [volledige documentatie](https://docs.choros.sh/setup-teardown-scripts).
...
Sneltoetsen zijn aanpasbaar via **Instellingen → Sneltoetsen** (⌘/); zie de [volledige sneltoetsenlijst](https://docs.choros.sh/keyboard-shortcuts).
...
We verwelkomen bijdragen! Zie [CONTRIBUTING.md](../CONTRIBUTING.md) voor hoe je aan de slag gaat en een PR opent. Bugs en featureverzoeken horen in [issues](https://github.com/superset-sh/choros/issues).
...
Word lid van de Choros-community om hulp te krijgen, feedback te delen en andere gebruikers te ontmoeten:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: chat met het team en de community
- **[Twitter](https://x.com/choros_sh)**: volg voor updates en aankondigingen
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: meld bugs en vraag features aan
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: stel vragen en deel ideeën
...
De hele app staat in deze repo onder de [Elastic License 2.0](../LICENSE.md): gebruik hem, fork hem, pas hem aan, self-host hem voor je team. Het enige dat niet mag, is Choros zelf herverpakken als een service die je aan anderen verkoopt.
