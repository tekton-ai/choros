...
<img width="full" alt="Claude a OpenCode pracují paralelně v pracovních prostorech Chorosu s živými diffy" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Stáhnout pro macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Dokumentace](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros spouští CLI kódovací agenty paralelně v izolovaných git worktree, s vestavěným terminálem, review a workflow otevření v editoru.
...
[Dokumentace →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude streamuje migraci billingu, zatímco další agenti běží v paralelních pracovních prostorech" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Agent dokončuje svůj úkol a stav v postranním panelu se přepíná z práce na hotovo" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Psaní navazujícího dotazu s @-zmínkou souboru v bohatém editoru promptů vedle rozděleného terminálu" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Kontrola změn agenta v diff prohlížeči" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="Vestavěný prohlížeč s náhledem dev serveru a detekovanými porty" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Naplánované automatizace agentů" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Hostitelé a členové v nastavení organizace" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Skriptujte z libovolného shellu: vytvářejte pracovní prostory, spouštějte agenty, čtěte jejich terminály a spravujte automatizace jedinou binárkou. Pokud agent umí spustit příkaz, umí řídit Choros.

[Dokumentace →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Vytvoření pracovního prostoru a spuštění agenta ze Choros CLI" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentace →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Psaní v paletě příkazů a živé filtrování akcí pracovního prostoru" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Vestavěné skills](https://docs.choros.sh/skills)**: agenti přicházejí s přednahranými skills `choros:*` (orchestrace paralelních agentů, plánování automatizací, odesílání zpětné vazby, diagnostika problémů), automaticky poskytnutými při spuštění
- **[Výběr modelu a vlastní agenti](https://docs.choros.sh/agent-integration)**: při spuštění zvolte model a úroveň uvažování a přidejte libovolného terminálového agenta s vlastní ikonou
- **[Skripty pro nastavení pracovního prostoru](https://docs.choros.sh/setup-teardown-scripts)**: automatizujte nastavení prostředí, instalaci závislostí a dev servery pro každý pracovní prostor
- **[Předvolby terminálu](https://docs.choros.sh/terminal-presets)**: uložte si rozložení agentů a shellů a otevřete je jedním stiskem klávesy
- **[Slack a Linear](https://docs.choros.sh/use-with-linear)**: vytvářejte pracovní prostory ze zpráv na Slacku nebo issues v Linearu
- **[Otevření ve vašem IDE](https://docs.choros.sh/use-with-ide)**: předání jedním kliknutím do Cursoru, VS Code nebo jakéhokoli editoru
- **[Vlastní motivy](https://docs.choros.sh/custom-themes)**: vytvářejte, upravujte a importujte soubory motivů
- **[Klávesové zkratky](https://docs.choros.sh/keyboard-shortcuts)**: každou akci lze přemapovat přes **Nastavení → Klávesové zkratky** (⌘/)
- **[Přineste si vlastní poskytovatele](https://docs.choros.sh/providers)**: připojte OpenRouter, Bedrock, Vertex nebo Vercel AI Gateway
- **A mnoho dalšího**: dodáváme denně, takže tento seznam je věčně pozadu. Skutečný seznam funkcí je [changelog](https://choros.sh/changelog).

## Podporovaní agenti

Choros funguje s libovolným CLI kódovacím agentem, mimo jiné:
...
Pokud běží v terminálu, běží na Chorosu
...
|:--------|:-------------|
| [**Desktopová aplikace**](https://github.com/superset-sh/choros/releases/latest) | Plnohodnotné IDE: terminály, diff prohlížeč, vestavěný prohlížeč, automatizace |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Jediná binárka `choros` pro správu pracovních prostorů, agentů, terminálů a hostitelů z libovolného shellu |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | Řiďte Choros programově pomocí [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) z Node, Bunu nebo Dena |
| [**MCP server**](https://docs.choros.sh/mcp) | Nechte Claude Code, Codex, Cursor a další agenty vytvářet a spravovat pracovní prostory samostatně |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (experimentální; primární platformou je macOS)
- **Windows**: zatím není k dispozici
- [Všechny buildy](https://github.com/superset-sh/choros/releases/latest)

Jediné, co potřebujete mít nainstalované, je [Git](https://git-scm.com/). [gh](https://cli.github.com/) je volitelný a odemyká PR workflow; Choros vám ho nabídne nainstalovat.

## Vývoj

Chcete na Chorosu bastlit nebo přispět PR? Naklonujte repozitář, přidejte ho do
nainstalované aplikace Choros a vytvořte pracovní prostor pro svou změnu:
...
běžet vedle nainstalované aplikace Choros a dalších vývojových worktree.
...
tlačítkem **"Sign in as dev"** (nebo `admin@local.test` / `chorosdev`).
...
Nakonfigurujte skripty setup, teardown a run pracovního prostoru v `.superset/config.json`. Viz [úplná dokumentace](https://docs.choros.sh/setup-teardown-scripts).
...
Klávesové zkratky si můžete přizpůsobit přes **Nastavení → Klávesové zkratky** (⌘/); viz [úplný seznam zkratek](https://docs.choros.sh/keyboard-shortcuts).
...
Příspěvky vítáme! V [CONTRIBUTING.md](../CONTRIBUTING.md) najdete, jak se nastavit a otevřít PR. Chyby a požadavky na funkce patří do [issues](https://github.com/superset-sh/choros/issues).
...
Připojte se ke komunitě Chorosu — získáte pomoc, můžete sdílet zpětnou vazbu a poznat další uživatele:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: chatujte s týmem a komunitou
- **[Twitter](https://x.com/choros_sh)**: sledujte novinky a oznámení
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: hlaste chyby a žádejte o funkce
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: ptejte se a sdílejte nápady
...
Celá aplikace je v tomto repozitáři pod licencí [Elastic License 2.0](../LICENSE.md): používejte ji, forkněte ji, upravujte ji, provozujte ji na vlastní infrastruktuře pro svůj tým. Jediné, co nejde, je přebalit samotný Choros jako službu, kterou prodáváte ostatním.
