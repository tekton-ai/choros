...
<img width="full" alt="Claude i OpenCode pracujące równolegle w obszarach roboczych Choros z podglądem różnic na żywo" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Pobierz na macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Dokumentacja](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros uruchamia agentów kodujących opartych na CLI równolegle w izolowanych worktree git, z wbudowanym terminalem, przeglądem zmian i otwieraniem w edytorze.
...
[Dokumentacja →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude strumieniuje migrację rozliczeń, podczas gdy inni agenci pracują w równoległych obszarach roboczych" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Agent kończy zadanie, a status na pasku bocznym zmienia się z pracuje na gotowe" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Wpisywanie kolejnego polecenia ze wzmianką pliku przez @ w rozbudowanym edytorze promptów obok podzielonego terminala" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Przeglądanie zmian agenta w podglądzie różnic" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="Przeglądarka w aplikacji z podglądem serwera deweloperskiego i wykrytymi portami" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Zaplanowane automatyzacje agentów" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Hosty i członkowie w ustawieniach organizacji" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Skryptuj z dowolnej powłoki: twórz obszary robocze, uruchamiaj agentów, czytaj ich terminale i zarządzaj automatyzacjami jednym plikiem binarnym. Jeśli agent potrafi uruchomić polecenie, potrafi też sterować Chorosem.

[Dokumentacja →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Tworzenie obszaru roboczego i uruchamianie agenta z Choros CLI" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Dokumentacja →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Wpisywanie w palecie poleceń i filtrowanie akcji obszaru roboczego na żywo" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Wbudowane umiejętności](https://docs.choros.sh/skills)**: agenci przychodzą z gotowymi umiejętnościami `choros:*` (orkiestracja równoległych agentów, planowanie automatyzacji, zgłaszanie opinii, diagnozowanie problemów), instalowanymi automatycznie przy starcie
- **[Wybór modelu i własni agenci](https://docs.choros.sh/agent-integration)**: wybierz model i poziom rozumowania przy starcie oraz dodaj dowolnego agenta terminalowego z własną ikoną
- **[Skrypty konfiguracji obszaru roboczego](https://docs.choros.sh/setup-teardown-scripts)**: automatyzuj konfigurację środowiska, instalację zależności i serwery deweloperskie per obszar roboczy
- **[Presety terminala](https://docs.choros.sh/terminal-presets)**: zapisuj układy agentów i powłok i otwieraj je jednym klawiszem
- **[Slack i Linear](https://docs.choros.sh/use-with-linear)**: twórz obszary robocze z wiadomości Slack lub zgłoszeń Linear
- **[Otwieranie w Twoim IDE](https://docs.choros.sh/use-with-ide)**: przekazanie jednym kliknięciem do Cursor, VS Code lub dowolnego edytora
- **[Własne motywy](https://docs.choros.sh/custom-themes)**: twórz, edytuj i importuj pliki motywów
- **[Skróty klawiszowe](https://docs.choros.sh/keyboard-shortcuts)**: każdą akcję można przemapować w **Ustawienia → Skróty klawiszowe** (⌘/)
- **[Własni dostawcy](https://docs.choros.sh/providers)**: podłącz OpenRouter, Bedrock, Vertex lub Vercel AI Gateway
- **I wiele więcej**: wydajemy codziennie, więc ta lista jest wiecznie w tyle. Prawdziwą listą funkcji jest [changelog](https://choros.sh/changelog).

## Obsługiwani agenci

Choros działa z każdym agentem kodującym opartym na CLI, w tym:
...
Jeśli działa w terminalu, działa w Choros
...
|:--------|:-------------|
| [**Aplikacja desktopowa**](https://github.com/superset-sh/choros/releases/latest) | Pełne IDE: terminale, podgląd różnic, przeglądarka w aplikacji, automatyzacje |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Pojedynczy plik binarny `choros` do zarządzania obszarami roboczymi, agentami, terminalami i hostami z dowolnej powłoki |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | Steruj Chorosem programistycznie przez [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) z Node, Bun lub Deno |
| [**Serwer MCP**](https://docs.choros.sh/mcp) | Pozwól Claude Code, Codex, Cursor i innym agentom samodzielnie tworzyć obszary robocze i nimi zarządzać |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (eksperymentalne; głównym celem jest macOS)
- **Windows**: jeszcze niedostępne
- [Wszystkie kompilacje](https://github.com/superset-sh/choros/releases/latest)

Jedyne, co trzeba mieć zainstalowane, to [Git](https://git-scm.com/). [gh](https://cli.github.com/) jest opcjonalny i odblokowuje przepływy pracy z PR; Choros zaproponuje jego instalację.

## Rozwój

Chcesz rozwijać Choros lub wnieść PR? Sklonuj repozytorium, dodaj je do
zainstalowanej aplikacji Choros i utwórz obszar roboczy dla swojej zmiany:
...
deweloperska aplikacja desktopowa może działać obok zainstalowanego Choros
...
przyciskiem **"Sign in as dev"** (lub `admin@local.test` / `chorosdev`).
...
Skonfiguruj skrypty setup, teardown i run obszaru roboczego w `.superset/config.json`. Zobacz [pełną dokumentację](https://docs.choros.sh/setup-teardown-scripts).
...
Skróty klawiszowe można dostosować w **Ustawienia → Skróty klawiszowe** (⌘/); zobacz [pełną listę skrótów](https://docs.choros.sh/keyboard-shortcuts).
...
Zapraszamy do współtworzenia! Zobacz [CONTRIBUTING.md](../CONTRIBUTING.md), aby dowiedzieć się, jak się przygotować i otworzyć PR. Błędy i propozycje funkcji zgłaszaj w [issues](https://github.com/superset-sh/choros/issues).
...
Dołącz do społeczności Choros, aby uzyskać pomoc, dzielić się opiniami i nawiązywać kontakty z innymi użytkownikami:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: rozmawiaj z zespołem i społecznością
- **[Twitter](https://x.com/choros_sh)**: obserwuj, aby śledzić aktualizacje i ogłoszenia
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: zgłaszaj błędy i proponuj funkcje
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: zadawaj pytania i dziel się pomysłami
...
Cała aplikacja znajduje się w tym repozytorium na licencji [Elastic License 2.0](../LICENSE.md): używaj jej, forkuj, modyfikuj, hostuj samodzielnie dla swojego zespołu. Jedyną rzeczą wykluczoną jest przepakowanie samego Choros jako usługi sprzedawanej innym.
