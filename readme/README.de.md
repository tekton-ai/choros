...
<img width="full" alt="Claude und OpenCode arbeiten parallel in Choros-Arbeitsbereichen mit Live-Diffs" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Für macOS herunterladen**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Dokumentation](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros führt CLI-basierte Coding-Agenten parallel in isolierten Git-Worktrees aus, mit integriertem Terminal, Review und Öffnen-im-Editor-Workflows.
...
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude streamt eine Billing-Migration, während andere Agenten in parallelen Arbeitsbereichen laufen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Ein Agent schließt seine Aufgabe ab und der Status in der Seitenleiste springt von „arbeitet“ auf „fertig“" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Eine Rückfrage mit einer @-Datei-Erwähnung im Prompt-Editor neben einem geteilten Terminal tippen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Die Änderungen eines Agenten im Diff-Viewer prüfen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="In-App-Browser mit Vorschau eines Dev-Servers und erkannten Ports" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Geplante Agenten-Automatisierungen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Hosts und Mitglieder in den Organisationseinstellungen" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Skripte es aus jeder Shell: Arbeitsbereiche erstellen, Agenten starten, ihre Terminals lesen und Automatisierungen verwalten, alles mit einem einzigen Binary. Wenn ein Agent einen Befehl ausführen kann, kann er Choros steuern.

[Docs →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Einen Arbeitsbereich erstellen und einen Agenten über die Choros-CLI starten" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="In der Befehlspalette tippen und Arbeitsbereich-Aktionen live filtern" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Integrierte Skills](https://docs.choros.sh/skills)**: Agenten kommen mit vorinstallierten `choros:*`-Skills (parallele Agenten orchestrieren, Automatisierungen planen, Feedback einreichen, Probleme diagnostizieren), die beim Start automatisch bereitgestellt werden
- **[Modellauswahl & eigene Agenten](https://docs.choros.sh/agent-integration)**: wähle beim Start ein Modell und den Reasoning-Aufwand und füge jeden Terminal-Agenten mit eigenem Icon hinzu
- **[Setup-Skripte für Arbeitsbereiche](https://docs.choros.sh/setup-teardown-scripts)**: automatisiere Umgebungs-Setup, Abhängigkeitsinstallation und Dev-Server pro Arbeitsbereich
- **[Terminal-Presets](https://docs.choros.sh/terminal-presets)**: speichere Agenten- und Shell-Layouts und öffne sie mit einem Tastendruck
- **[Slack & Linear](https://docs.choros.sh/use-with-linear)**: erstelle Arbeitsbereiche aus Slack-Nachrichten oder Linear-Issues
- **[In deiner IDE öffnen](https://docs.choros.sh/use-with-ide)**: Ein-Klick-Übergabe an Cursor, VS Code oder jeden anderen Editor
- **[Eigene Themes](https://docs.choros.sh/custom-themes)**: erstelle, bearbeite und importiere Theme-Dateien
- **[Tastenkürzel](https://docs.choros.sh/keyboard-shortcuts)**: jede Aktion lässt sich unter **Einstellungen → Tastenkürzel** (⌘/) neu belegen
- **[Bring deine eigenen Provider mit](https://docs.choros.sh/providers)**: verbinde OpenRouter, Bedrock, Vertex oder Vercel AI Gateway
- **Und vieles mehr**: wir shippen täglich, diese Liste hinkt also immer hinterher. Der [Changelog](https://choros.sh/changelog) ist die echte Funktionsliste.

## Unterstützte Agenten

Choros funktioniert mit jedem CLI-basierten Coding-Agenten, unter anderem:
...
Wenn es im Terminal läuft, läuft es auf Choros
...
|:--------|:-------------|
| [**Desktop-App**](https://github.com/superset-sh/choros/releases/latest) | Die komplette IDE: Terminals, Diff-Viewer, In-App-Browser, Automatisierungen |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Ein einziges `choros`-Binary, um Arbeitsbereiche, Agenten, Terminals und Hosts aus jeder Shell zu verwalten |
| [**TypeScript-SDK**](https://docs.choros.sh/sdk/getting-started) | Steuere Choros programmatisch mit [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) aus Node, Bun oder Deno |
| [**MCP-Server**](https://docs.choros.sh/mcp) | Lass Claude Code, Codex, Cursor und andere Agenten Arbeitsbereiche selbst erstellen und verwalten |
...
- **Linux**: [x64-AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (experimentell; macOS ist die primäre Zielplattform)
- **Windows**: noch nicht verfügbar
- [Alle Builds](https://github.com/superset-sh/choros/releases/latest)

Alles, was du installiert brauchst, ist [Git](https://git-scm.com/). [gh](https://cli.github.com/) ist optional und schaltet die PR-Workflows frei; Choros bietet an, es für dich zu installieren.

## Entwicklung

Du willst an Choros hacken oder eine PR beisteuern? Klone das Repository, füge es der
installierten Choros-App hinzu und erstelle einen Arbeitsbereich für deine Änderung:
...
neben der installierten Choros-App und anderen Entwicklungs-Worktrees laufen kann.
...
mit dem Button **„Sign in as dev“** an (oder `admin@local.test` / `chorosdev`).
...
Konfiguriere Setup-, Teardown- und Run-Skripte für Arbeitsbereiche in `.superset/config.json`. Siehe die [vollständige Dokumentation](https://docs.choros.sh/setup-teardown-scripts).
...
Tastenkürzel lassen sich unter **Einstellungen → Tastenkürzel** (⌘/) anpassen; siehe die [vollständige Liste der Tastenkürzel](https://docs.choros.sh/keyboard-shortcuts).
...
Beiträge sind willkommen! Siehe [CONTRIBUTING.md](../CONTRIBUTING.md) für den Einstieg und wie du eine PR öffnest. Bugs und Feature-Wünsche gehören in die [Issues](https://github.com/superset-sh/choros/issues).
...
Tritt der Choros-Community bei, um Hilfe zu bekommen, Feedback zu teilen und dich mit anderen auszutauschen:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: chatte mit dem Team und der Community
- **[Twitter](https://x.com/choros_sh)**: folge uns für Updates und Ankündigungen
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: melde Bugs und wünsch dir Features
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: stell Fragen und teile Ideen
...
Die gesamte App liegt in diesem Repository unter der [Elastic License 2.0](../LICENSE.md): nutze sie, forke sie, verändere sie, hoste sie selbst für dein Team. Das Einzige, was nicht geht, ist, Choros selbst als Dienst neu zu verpacken und an andere zu verkaufen.
