...
<img width="full" alt="Claude 与 OpenCode 在并行的 Choros 工作区中工作并实时显示差异" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**下载 macOS 版**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [文档](https://docs.choros.sh) &nbsp;&bull;&nbsp; [更新日志](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros 在相互隔离的 git worktree 中并行运行基于 CLI 的编码智能体,并内置终端、审查和在编辑器中打开的工作流。
...
[文档 →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude 正在流式输出一次计费迁移,其他智能体在并行工作区中运行" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="一个智能体完成任务,侧边栏状态从工作中切换为已完成" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="在分屏终端旁的富文本提示词编辑器中输入带 @ 文件提及的后续指令" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="在差异查看器中审查智能体的更改" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="应用内浏览器预览开发服务器并显示检测到的端口" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="按计划运行的智能体自动化" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="组织设置中的主机与成员" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
在任何 shell 中编写脚本:用单个二进制文件创建工作区、启动智能体、读取它们的终端、管理自动化。只要智能体能运行命令,它就能驱动 Choros。

[文档 →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="通过 Choros CLI 创建工作区并启动智能体" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[文档 →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="在命令面板中输入并实时筛选工作区操作" width="100%" /></a>
</td>
</tr>
</table>
...
- **[内置技能](https://docs.choros.sh/skills)**:智能体预装 `choros:*` 技能(编排并行智能体、安排自动化、提交反馈、诊断问题),启动时自动配置
- **[模型选择器与自定义智能体](https://docs.choros.sh/agent-integration)**:启动时选择模型和推理力度,并可为任何终端智能体添加专属图标
- **[工作区设置脚本](https://docs.choros.sh/setup-teardown-scripts)**:按工作区自动化环境配置、依赖安装和开发服务器
- **[终端预设](https://docs.choros.sh/terminal-presets)**:保存智能体和 shell 布局,一键打开
- **[Slack 与 Linear](https://docs.choros.sh/use-with-linear)**:从 Slack 消息或 Linear issue 直接创建工作区
- **[在你的 IDE 中打开](https://docs.choros.sh/use-with-ide)**:一键交接到 Cursor、VS Code 或任何编辑器
- **[自定义主题](https://docs.choros.sh/custom-themes)**:构建、编辑和导入主题文件
- **[键盘快捷键](https://docs.choros.sh/keyboard-shortcuts)**:每个操作都可通过**设置 → 键盘快捷键**(⌘/)重新映射
- **[自带提供商](https://docs.choros.sh/providers)**:连接 OpenRouter、Bedrock、Vertex 或 Vercel AI Gateway
- **还有更多**:我们每天发布新版本,这份列表永远落后于实际。真正的功能列表是[更新日志](https://choros.sh/changelog)。

## 支持的智能体

Choros 适用于任何基于 CLI 的编码智能体,包括:
...
| 界面 | 你能得到什么 |
|:--------|:-------------|
| [**桌面应用**](https://github.com/superset-sh/choros/releases/latest) | 完整的 IDE:终端、差异查看器、应用内浏览器、自动化 |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | 单个 `choros` 二进制文件,在任何 shell 中管理工作区、智能体、终端和主机 |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | 通过 [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) 在 Node、Bun 或 Deno 中以编程方式驱动 Choros |
| [**MCP 服务器**](https://docs.choros.sh/mcp) | 让 Claude Code、Codex、Cursor 等智能体自己创建和管理工作区 |
...
- **Linux**:[x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage)(实验性;macOS 是主要目标平台)
- **Windows**:暂不可用
- [所有构建版本](https://github.com/superset-sh/choros/releases/latest)

你只需要安装 [Git](https://git-scm.com/)。[gh](https://cli.github.com/) 是可选的,用于解锁 PR 工作流;Choros 会主动提议为你安装。

## 开发

想折腾 Choros 或贡献一个 PR?克隆仓库,把它添加到已安装的 Choros 应用中,然后为你的更改创建一个工作区:
...
在每个新 worktree 中运行一次 `setup.local.sh`。它会配置工作区专属的应用标识和端口,让开发版桌面应用可以与已安装的 Choros 应用及其他开发 worktree 并行运行。

无需 Neon 账号或第三方凭据。`setup.local.sh` 会通过 Docker 启动本地 Postgres + Electric 栈并植入一个开发账号。用 **"Sign in as dev"** 按钮(或 `admin@local.test` / `chorosdev`)登录即可。
...
在 `.superset/config.json` 中配置工作区的设置、清理和运行脚本。参见[完整文档](https://docs.choros.sh/setup-teardown-scripts)。
...
键盘快捷键可通过**设置 → 键盘快捷键**(⌘/)自定义;参见[完整快捷键列表](https://docs.choros.sh/keyboard-shortcuts)。
...
我们欢迎贡献!参见 [CONTRIBUTING.md](../CONTRIBUTING.md) 了解如何搭建环境并提交 PR。Bug 和功能请求请提交到 [issues](https://github.com/superset-sh/choros/issues)。
...
加入 Choros 社区,获取帮助、分享反馈,并与其他用户交流:

- **[Discord](https://discord.gg/cZeD9WYcV7)**:与团队和社区聊天
- **[Twitter](https://x.com/choros_sh)**:关注以获取更新和公告
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**:报告 bug 和请求功能
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**:提问和分享想法
...
整个应用都在这个仓库中,采用 [Elastic License 2.0](../LICENSE.md) 许可:使用它、fork 它、修改它、为你的团队自托管它,都可以。唯一不允许的,是把 Choros 本身重新打包成服务卖给他人。
