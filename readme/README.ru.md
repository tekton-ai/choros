...
<img width="full" alt="Claude и OpenCode работают параллельно в рабочих областях Choros с живыми diff" src="../apps/marketing/public/images/readme-hero.gif" />
...
[**Скачать для macOS**](https://github.com/superset-sh/choros/releases/latest) &nbsp;&bull;&nbsp; [Документация](https://docs.choros.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/superset-sh/choros/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
Choros запускает CLI-агентов для кодинга параллельно в изолированных git worktree, со встроенным терминалом, ревью изменений и открытием в редакторе.
...
[Документация →](https://docs.choros.sh/workspaces)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/workspaces"><img src="../apps/marketing/public/images/readme/agents-working.gif" alt="Claude стримит миграцию биллинга, пока другие агенты работают в параллельных рабочих областях" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/agent-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/agent-integration"><img src="../apps/marketing/public/images/readme/agent-monitoring.gif" alt="Агент завершает задачу, и статус в боковой панели меняется с «работает» на «готово»" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/terminal-integration)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/terminal-integration"><img src="../apps/marketing/public/images/readme/terminal.gif" alt="Ввод уточнения с упоминанием файла через @ в расширенном редакторе промптов рядом с разделённым терминалом" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/diff-viewer)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/diff-viewer"><img src="../apps/marketing/public/images/readme/diff-viewer.png" alt="Ревью изменений агента в просмотрщике diff" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/browser)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/browser"><img src="../apps/marketing/public/images/readme/browser-ports.png" alt="Встроенный браузер показывает превью dev-сервера с определёнными портами" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/automations)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/automations"><img src="../apps/marketing/public/images/readme/automations.png" alt="Автоматизации агентов по расписанию" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/remote-access)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/remote-access"><img src="../apps/docs/public/images/remote-workspaces-hosts-members.png" alt="Хосты и участники в настройках организации" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
Скриптуйте из любой оболочки: создавайте рабочие области, запускайте агентов, читайте их терминалы и управляйте автоматизациями одним бинарником. Если агент умеет выполнять команды, он умеет управлять Choros.

[Документация →](https://docs.choros.sh/cli/getting-started)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/cli/getting-started"><img src="../apps/marketing/public/images/readme/cli-demo.gif" alt="Создание рабочей области и запуск агента из Choros CLI" width="100%" /></a>
</td>
</tr>
<tr>
<td width="50%" valign="middle">
...
[Документация →](https://docs.choros.sh/keyboard-shortcuts)

</td>
<td width="50%">
  <a href="https://docs.choros.sh/keyboard-shortcuts"><img src="../apps/marketing/public/images/readme/command-palette.gif" alt="Ввод в палитре команд с живой фильтрацией действий рабочей области" width="100%" /></a>
</td>
</tr>
</table>
...
- **[Встроенные навыки](https://docs.choros.sh/skills)**: агенты поставляются с предустановленными навыками `choros:*` (оркестрация параллельных агентов, планирование автоматизаций, отправка отзывов, диагностика проблем), которые устанавливаются автоматически при запуске
- **[Выбор модели и пользовательские агенты](https://docs.choros.sh/agent-integration)**: выбирайте модель и уровень рассуждений при запуске и добавляйте любого терминального агента с собственной иконкой
- **[Скрипты настройки рабочей области](https://docs.choros.sh/setup-teardown-scripts)**: автоматизируйте настройку окружения, установку зависимостей и dev-серверы для каждой рабочей области
- **[Пресеты терминала](https://docs.choros.sh/terminal-presets)**: сохраняйте раскладки агентов и оболочек и открывайте их одним нажатием
- **[Slack и Linear](https://docs.choros.sh/use-with-linear)**: создавайте рабочие области из сообщений Slack или задач Linear
- **[Открытие в вашей IDE](https://docs.choros.sh/use-with-ide)**: передача в Cursor, VS Code или любой редактор в один клик
- **[Пользовательские темы](https://docs.choros.sh/custom-themes)**: создавайте, редактируйте и импортируйте файлы тем
- **[Горячие клавиши](https://docs.choros.sh/keyboard-shortcuts)**: любое действие можно переназначить в **Настройки → Горячие клавиши** (⌘/)
- **[Свои провайдеры](https://docs.choros.sh/providers)**: подключайте OpenRouter, Bedrock, Vertex или Vercel AI Gateway
- **И многое другое**: мы выпускаем обновления каждый день, так что этот список вечно отстаёт. Настоящий список возможностей — [changelog](https://choros.sh/changelog).

## Поддерживаемые агенты

Choros работает с любым CLI-агентом для кодинга, в том числе:
...
Если он запускается в терминале, он работает в Choros
...
|:--------|:-------------|
| [**Десктопное приложение**](https://github.com/superset-sh/choros/releases/latest) | Полноценная IDE: терминалы, просмотрщик diff, встроенный браузер, автоматизации |
| [**CLI**](https://docs.choros.sh/cli/getting-started) | Единый бинарник `choros` для управления рабочими областями, агентами, терминалами и хостами из любой оболочки |
| [**TypeScript SDK**](https://docs.choros.sh/sdk/getting-started) | Управляйте Choros программно через [`@choros_sh/sdk`](https://www.npmjs.com/package/@choros_sh/sdk) из Node, Bun или Deno |
| [**Сервер MCP**](https://docs.choros.sh/mcp) | Позвольте Claude Code, Codex, Cursor и другим агентам самим создавать рабочие области и управлять ими |
...
- **Linux**: [x64 AppImage](https://github.com/superset-sh/choros/releases/latest/download/Choros-x86_64.AppImage) (экспериментально; основная платформа — macOS)
- **Windows**: пока недоступно
- [Все сборки](https://github.com/superset-sh/choros/releases/latest)

Из установленного нужен только [Git](https://git-scm.com/). [gh](https://cli.github.com/) необязателен и открывает рабочие процессы с PR; Choros предложит установить его за вас.

## Разработка

Хотите поработать над Choros или прислать PR? Клонируйте репозиторий, добавьте его
в установленное приложение Choros и создайте рабочую область для своих изменений:
...
приложение для разработки могло работать рядом с установленным Choros и другими
...
кнопкой **"Sign in as dev"** (или `admin@local.test` / `chorosdev`).
...
Настройте скрипты setup, teardown и run для рабочих областей в `.superset/config.json`. См. [полную документацию](https://docs.choros.sh/setup-teardown-scripts).
...
Горячие клавиши настраиваются в **Настройки → Горячие клавиши** (⌘/); см. [полный список сочетаний](https://docs.choros.sh/keyboard-shortcuts).
...
Мы рады вкладу сообщества! См. [CONTRIBUTING.md](../CONTRIBUTING.md) о том, как настроить окружение и открыть PR. Баги и запросы функций — в [issues](https://github.com/superset-sh/choros/issues).
...
Присоединяйтесь к сообществу Choros, чтобы получать помощь, делиться отзывами и общаться с другими пользователями:

- **[Discord](https://discord.gg/cZeD9WYcV7)**: общайтесь с командой и сообществом
- **[Twitter](https://x.com/choros_sh)**: подписывайтесь на обновления и анонсы
- **[GitHub Issues](https://github.com/superset-sh/choros/issues)**: сообщайте о багах и предлагайте функции
- **[GitHub Discussions](https://github.com/superset-sh/choros/discussions)**: задавайте вопросы и делитесь идеями
...
Всё приложение находится в этом репозитории под [Elastic License 2.0](../LICENSE.md): используйте, форкайте, изменяйте, разворачивайте для своей команды. Единственное, что запрещено — переупаковывать сам Choros в сервис и продавать его другим.
