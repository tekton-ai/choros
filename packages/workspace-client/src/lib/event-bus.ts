...
import type { RelayAffinityProbe } from "./prime-relay-affinity";
import { createRelaySocket, type RelaySocket } from "./relay-socket";
...
export interface AgentLifecyclePayload {
	...
	terminalId: string;
	// Absent when the hook ran without `CHOROS_AGENT_ID` set.
	agent?: AgentIdentity;
	occurredAt: number;
}
