		...
		inputSchema: z
			.object({
				...
				workspaceId: pageFields.workspaceId.describe(
					"The workspace this page belongs to. Required: a page that names no workspace is listed by nothing and cannot be versioned later. Get it from the `CHOROS_WORKSPACE_ID` environment variable, or by running `choros workspaces list`.",
				),
