...
Email templates for Choros, built with [React Email](https://react.email).
...
```bash
NEXT_PUBLIC_MARKETING_URL=https://choros.sh
```
...
**Example:**
```tsx
<Button href="https://app.choros.sh">Get Started</Button>
<Button href="https://choros.sh" variant="secondary">
  Learn More
</Button>
```
