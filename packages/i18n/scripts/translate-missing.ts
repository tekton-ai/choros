...
async function translateLocale(
	...
	const stream = client.messages.stream({
		...
		system: [
			"You translate UI strings for Choros, a desktop IDE for running coding agents (a personal fork of Superset).",
			...
			`- ${pluralRule}`,
			"- Brand and product names (Choros, Superset, GitHub, Claude, Slack, VS Code, Cursor, …), code, file paths, CLI flags, and keyboard glyphs stay verbatim.",
