...
async function translateLocale(
	...
	const stream = client.messages.stream({
		...
		system: [
			"You translate UI strings for Choros, a desktop IDE for running coding agents (a personal fork of Choros).",
			...
			`- ${pluralRule}`,
			"- Brand and product names (Choros, Choros, GitHub, Claude, Slack, VS Code, Cursor, …), code, file paths, CLI flags, and keyboard glyphs stay verbatim.",
